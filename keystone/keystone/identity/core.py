...
class DomainConfigs(dict):
    ...
    def _load_driver(self, domain_config, assignment_api):
        print u"_load_driver.domain_config:  %s" % domain_config
        ...
        print u"_load_driver.domain_config_driver %s" % domain_config_driver
        return domain_config_driver

    def _load_config(self, assignment_api, file_list, domain_name):
        print u"/opt/stack/keystone/keystone/identity/core.py:_load_config file_list=%s" % file_list

        def assert_no_more_than_one_sql_driver(new_config, config_file):
            print "/opt/stack/keystone/keystone/identity/core.py:assert_no_more_than_one_sql_driver"
            ...
            """
            print u"new_config: %s" % (new_config)
            ...
            print u"_any_sql= %s" % self._any_sql
        try:
        ...
        print u"domain_config: %s" % domain_config['driver'] 
